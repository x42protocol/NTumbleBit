    ...
    public class PaymentStateMachine
    {
            ...
            State state) : this(runtime)
        {
            ...
            if (state.SolverClientState != null)
                SolverClientSession = new SolverClientSession(runtime.Network, runtime.TumblerParameters.CreateSolverParamaters(), state.SolverClientState);
            Status = state.Status;
        }
                ...
                switch (phase)
                {
                    ...
                    case CyclePhase.ClientChannelEstablishment:
                        if (Status == PaymentStateMachineStatus.Registered)
                        {
                            ...
                            var redeemTx = SolverClientSession.CreateRedeemTransaction(Runtime.Network, feeRate);

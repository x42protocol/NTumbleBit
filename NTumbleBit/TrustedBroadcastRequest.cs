...
namespace NTumbleBit
{
    public class TrustedBroadcastRequest
    {
        ...
        public Transaction ReSign(Network network, Coin coin)
        {
            return ReSign(network, coin, out bool a);
        }
        public Transaction ReSign(Network network, Coin coin, out bool cached)
        {
            var transaction = Transaction.Clone(network.Consensus.ConsensusFactory);
